...
enum OutputType : int
{
    ...
    // FIXME: Update once we have segwit on PowerBlockCoin.
...
public:
    ...
    void BlockDisconnected(const std::shared_ptr<const CBlock>& pblock, const CBlockIndex *pindexDelete) override;
