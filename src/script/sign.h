...
public:
    ...
    virtual bool CreateSig(std::vector<unsigned char>& vchSig, const CKeyID& keyid, const CScript& scriptCode, SigVersion sigversion, CKey *key = NULL, void *extraData = NULL) const =0;
};
...
public:
    ...
    bool CreateSig(std::vector<unsigned char>& vchSig, const CKeyID& keyid, const CScript& scriptCode, SigVersion sigversion, CKey *key = NULL, void *extraData = NULL) const override;
};
