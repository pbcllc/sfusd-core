...
/*
    S4 end height calc clarification:
    On 31.05.2021 there is ~1300 blocks per day, 31.05.2021 starts from block 44704, so,
    01.06.2021 starts from block 46004, and 14.06 (S5 hardfork in KMD) starts from 64204 block. Plus
    half of a day - 64854.
*/
/*
    season 6 activation
    chain is averaging 1312 blocks/day and we are targeting 1656077853 - Fri Jun 24 2022 13:37:33 GMT+0000
*/
static const int32_t KMD_SEASON_HEIGHTS[NUM_KMD_SEASONS] = {0, 1, 2, 64854, 535680, 999999999};
    ...
    if ( pwallet != 0 )
    {
        ...
        if ( IsValidDestination(address) != 0 )
        {
            ...
            else
            {
                ...
                pwallet->MarkDirty();
                pwallet->AddWatchOnly(GetScriptForDestination(address), 0);
