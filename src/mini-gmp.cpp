...
int
mpz_cmp_si (const mpz_t u, int64_t v)
{
  mp_size_t usize = u->_mp_size;
...
{
  mpz_div_qr (q, r, n, d, mpz_div_round_mode::GMP_DIV_FLOOR);
}
...
{
  mpz_div_qr (q, NULL, n, d, mpz_div_round_mode::GMP_DIV_CEIL);
}

void
mpz_fdiv_q (mpz_t q, const mpz_t n, const mpz_t d)
{
  mpz_div_qr (q, NULL, n, d, mpz_div_round_mode::GMP_DIV_FLOOR);
}
...
{
  mpz_div_qr (q, NULL, n, d, mpz_div_round_mode::GMP_DIV_TRUNC);
}
...
{
  mpz_div_qr (NULL, r, n, d, mpz_div_round_mode::GMP_DIV_CEIL);
}

void
mpz_fdiv_r (mpz_t r, const mpz_t n, const mpz_t d)
{
  mpz_div_qr (NULL, r, n, d, mpz_div_round_mode::GMP_DIV_FLOOR);
}

void
mpz_tdiv_r (mpz_t r, const mpz_t n, const mpz_t d)
{
  mpz_div_qr (NULL, r, n, d, mpz_div_round_mode::GMP_DIV_TRUNC);
}

void
mpz_mod (mpz_t r, const mpz_t n, const mpz_t d)
{
  mpz_div_qr (NULL, r, n, d, d->_mp_size >= 0 ? mpz_div_round_mode::GMP_DIV_FLOOR : mpz_div_round_mode::GMP_DIV_CEIL);
}
		...
		enum mpz_div_round_mode mode)
{
  ...
  if (mode == ((un > 0) ? mpz_div_round_mode::GMP_DIV_CEIL : mpz_div_round_mode::GMP_DIV_FLOOR)) /* un != 0 here. */
  ...
  if (rn > un)
    {
	 ...
	 non-zero */
      if (mode == ((us > 0) ? mpz_div_round_mode::GMP_DIV_CEIL : mpz_div_round_mode::GMP_DIV_FLOOR)) /* us != 0 here. */
	{
...
{
  mpz_div_q_2exp (r, u, cnt, mpz_div_round_mode::GMP_DIV_CEIL);
}

void
mpz_fdiv_q_2exp (mpz_t r, const mpz_t u, mp_bitcnt_t cnt)
{
  mpz_div_q_2exp (r, u, cnt, mpz_div_round_mode::GMP_DIV_FLOOR);
}

void
mpz_tdiv_q_2exp (mpz_t r, const mpz_t u, mp_bitcnt_t cnt)
{
  mpz_div_q_2exp (r, u, cnt, mpz_div_round_mode::GMP_DIV_TRUNC);
}

void
mpz_cdiv_r_2exp (mpz_t r, const mpz_t u, mp_bitcnt_t cnt)
{
  mpz_div_r_2exp (r, u, cnt, mpz_div_round_mode::_CEIL);
}

void
mpz_fdiv_r_2exp (mpz_t r, const mpz_t u, mp_bitcnt_t cnt)
{
  mpz_div_r_2exp (r, u, cnt, mpz_div_round_mode::GMP_DIV_FLOOR);
}

void
mpz_tdiv_r_2exp (mpz_t r, const mpz_t u, mp_bitcnt_t cnt)
{
  mpz_div_r_2exp (r, u, cnt, mpz_div_round_mode::GMP_DIV_TRUNC);
}

void
mpz_divexact (mpz_t q, const mpz_t n, const mpz_t d)
{
  gmp_assert_nocarry (mpz_div_qr (q, NULL, n, d, mpz_div_round_mode::GMP_DIV_TRUNC));
}

int
mpz_divisible_p (const mpz_t n, const mpz_t d)
{
  return mpz_div_qr (NULL, NULL, n, d, mpz_div_round_mode::GMP_DIV_TRUNC) == 0;
}
...
{
  return mpz_div_qr_ui (q, r, n, d,  mpz_div_round_mode::GMP_DIV_CEIL);
}

uint64_t
mpz_fdiv_qr_ui (mpz_t q, mpz_t r, const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (q, r, n, d,  mpz_div_round_mode::GMP_DIV_FLOOR);
}

uint64_t
mpz_tdiv_qr_ui (mpz_t q, mpz_t r, const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (q, r, n, d,  mpz_div_round_mode::GMP_DIV_TRUNC);
}

uint64_t
mpz_cdiv_q_ui (mpz_t q, const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (q, NULL, n, d,  mpz_div_round_mode::GMP_DIV_CEIL);
}

uint64_t
mpz_fdiv_q_ui (mpz_t q, const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (q, NULL, n, d,  mpz_div_round_mode::GMP_DIV_FLOOR);
}
...
{
  return mpz_div_qr_ui (q, NULL, n, d, mpz_div_round_mode::GMP_DIV_TRUNC);
}
#ifdef nonessential
uint64_t
mpz_cdiv_r_ui (mpz_t r, const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (NULL, r, n, d,  mpz_div_round_mode::GMP_DIV_CEIL);
}
uint64_t
mpz_fdiv_r_ui (mpz_t r, const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (NULL, r, n, d,  mpz_div_round_mode::GMP_DIV_FLOOR);
}
uint64_t
mpz_tdiv_r_ui (mpz_t r, const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (NULL, r, n, d,  mpz_div_round_mode::GMP_DIV_TRUNC);
}

uint64_t
mpz_cdiv_ui (const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (NULL, NULL, n, d,  mpz_div_round_mode::GMP_DIV_CEIL);
}

uint64_t
mpz_fdiv_ui (const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (NULL, NULL, n, d,  mpz_div_round_mode::GMP_DIV_FLOOR);
}

uint64_t
mpz_tdiv_ui (const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (NULL, NULL, n, d,  mpz_div_round_mode::GMP_DIV_TRUNC);
}
...
{
  gmp_assert_nocarry (mpz_div_qr_ui (q, NULL, n, d,  mpz_div_round_mode::GMP_DIV_TRUNC));
}

int
mpz_divisible_ui_p (const mpz_t n, uint64_t d)
{
  return mpz_div_qr_ui (NULL, NULL, n, d,  mpz_div_round_mode::GMP_DIV_TRUNC) == 0;
}
...
static int mpz_div_qr (mpz_t q, mpz_t r,const mpz_t n, const mpz_t d, enum mpz_div_round_mode mode)
{
    ...
    if (nn < dn)
    {
        if (mode ==  mpz_div_round_mode::GMP_DIV_CEIL && qs >= 0)
        {
            /* q = 1, r = n - d */
            if (r)
                mpz_sub (r, n, d);
        ...
        else if (mode ==  mpz_div_round_mode::GMP_DIV_FLOOR && qs < 0)
        {
            /* q = -1, r = n + d */
            if (r)
                mpz_add (r, n, d);
    ...
    else
    {
        ...
        if (mode ==  mpz_div_round_mode::GMP_DIV_FLOOR && qs < 0 && rn != 0)
        {
            if (q)
                mpz_sub_ui (tq, tq, 1);
            if (r)
        ...
        else if (mode ==  mpz_div_round_mode::GMP_DIV_CEIL && qs >= 0 && rn != 0)
        {
            if (q)
                mpz_add_ui (tq, tq, 1);
            if (r)
...
{
    mpz_div_qr (q, r, n, d,  mpz_div_round_mode::GMP_DIV_CEIL);
}
...
{
    mpz_div_qr (q, r, n, d,  mpz_div_round_mode::GMP_DIV_TRUNC);
}
...
static uint64_t mpz_div_qr_ui (mpz_t q, mpz_t r,const mpz_t n, uint64_t d, enum mpz_div_round_mode mode)
{
    ...
    rs = rl > 0;
    rs = (ns < 0) ? -rs : rs;
    if (rl > 0 && ( (mode ==  mpz_div_round_mode::GMP_DIV_FLOOR && ns < 0) || (mode ==  mpz_div_round_mode::GMP_DIV_CEIL && ns >= 0)))
    {
        if (q)
